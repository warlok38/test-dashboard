...
- Do not write or maintain tests in this project unless the user explicitly asks for tests in a specific task. Use `npm.cmd run lint` and `npm.cmd run build` for routine verification.
